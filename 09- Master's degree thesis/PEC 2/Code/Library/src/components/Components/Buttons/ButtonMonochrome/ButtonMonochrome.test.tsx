...
describe("<ButtonMonochrome />", () => {
  ...
  it("should render no default options", () => {
    const wrapper = mount(<ButtonMonochrome label="Test" size="large" style="lime" />);
    expect(wrapper.props().label).toBe("Test");
  ...
  it("should render size small", () => {
    const wrapper = mount(<ButtonMonochrome label="Test" size="small" style="blue" />);
    expect(wrapper.props().label).toBe("Test");
  ...
  it("should render size large", () => {
    const wrapper = mount(<ButtonMonochrome label="Test" size="large" style="cyan" />);
    expect(wrapper.props().label).toBe("Test");
    expect(wrapper.props().size).toBe("large");
  ...
  it("should render size xlarge", () => {
    const wrapper = mount(<ButtonMonochrome label="Test" size="xlarge" style="red" />);
    expect(wrapper.props().label).toBe("Test");
  ...
  it("should render size xsmall", () => {
    const wrapper = mount(<ButtonMonochrome label="Test" size="xsmall" style="pink" />);
    expect(wrapper.props().label).toBe("Test");
  ...
  it("should render customClass", () => {
    const wrapper = mount(<ButtonMonochrome label="Test" classButton="customClass" />);
    expect(wrapper.props().label).toBe("Test");
    expect(wrapper.props().classButton).toBe("customClass");
  });
  it("should render disabled", () => {
    const wrapper = mount(<ButtonMonochrome label="Test" disabled={true} />);
    expect(wrapper.props().label).toBe("Test");
    expect(wrapper.props().disabled).toBe(true);
  });
  it("should render loading", () => {
    const wrapper = mount(<ButtonMonochrome label="Test" loading={true} />);
    expect(wrapper.props().label).toBe("Test");
    expect(wrapper.props().loading).toBe(true);
  });
  it("should render shadow", () => {
    const wrapper = mount(<ButtonMonochrome label="Test" kind="shadow" />);
    expect(wrapper.props().label).toBe("Test");
    expect(wrapper.props().kind).toBe("shadow");
  });
});
